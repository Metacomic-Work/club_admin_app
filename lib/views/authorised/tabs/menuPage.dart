        ...
        child: Container(
          ...
          child: Card(
            ...
            child: const Center(
              ...
              "Add Banner",
              style: TextStyle(
                  fontFamily: 'sen', fontSize: 18, fontWeight: FontWeight.w300),
            )),
          ),
        ),
      ),
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Text(
                  "Menu",
                  style: TextStyle(
                      fontSize: 25, color: Colors.black, fontFamily: 'sen'),
                ),
              ),
            ),
            Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: NetworkImage(restaurantController
                              .restaurantModel.value.restaurantImage
                              .toString()),
                          fit: BoxFit.cover,
                        )),
                  ),
                      ...
                      children: [
                        Text(
                          restaurantController
                              .restaurantModel.value.restaurantName
                              .toString(),
                          style: TextStyle(
                              fontFamily: 'sen',
                              fontSize: 22,
                        ...
                        Text(
                          restaurantController.restaurantModel.value.type
                              .toString(),
                          style: TextStyle(
                              fontFamily: 'sen',
                              fontSize: 12,
