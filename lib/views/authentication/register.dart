...
class _RegisterPageState extends State<RegisterPage> {
        ...
        body: SingleChildScrollView(
            ...
            child: SizedBox(
              ...
              children: [
                ...
                if (userController.UserModel.value.profileImage != null)
                  SizedBox(
                    child: Center(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: FileImage(userController.UserModel.value.profileImage!),
                              fit: BoxFit.cover,
                            )),
                      ),
                    )),
  ...
  void getImage({required ImageSource source}) async {
    ...
    if (file?.path != null) {
      setState(() {
        userController.UserModel.value.profileImage = File(file!.path);
      });
    }
  }
}
